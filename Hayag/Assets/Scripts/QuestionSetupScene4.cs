...
public class QuestionSetupScene4 : MonoBehaviour
{
    [SerializeField] private List<QuestionDataScene4> questions;
    [SerializeField] private TextMeshProUGUI questionText;
    [SerializeField] private TextMeshProUGUI categoryText;
    [SerializeField] private AnswerButtonScene4[] answerButtons;
    ...
    {
        public QuestionDataScene4 question;
    ...
    {
        questions = new List<QuestionDataScene4>(Resources.LoadAll<QuestionDataScene4>("QuestionsScene4"));
    ...
    private void DisplayCurrentQuestion()
    {
        ...
        QuestionDataScene4 currentQuestion = currentState.question;
    ...
    public void AnswerSelected(bool isCorrect, AnswerButtonScene4 clickedButton)
    {
