...
public class QuestionSetupScene2 : MonoBehaviour
{
    [SerializeField] private List<QuestionDataScene2> questions;
    [SerializeField] private TextMeshProUGUI questionText;
    [SerializeField] private TextMeshProUGUI categoryText;
    [SerializeField] private AnswerButtonScene2[] answerButtons;
    ...
    {
        public QuestionDataScene2 question;
    ...
    {
        questions = new List<QuestionDataScene2>(Resources.LoadAll<QuestionDataScene2>("QuestionsScene2"));
    ...
    private void DisplayCurrentQuestion()
    {
        ...
        QuestionDataScene2 currentQuestion = currentState.question;
    ...
    public void AnswerSelected(bool isCorrect, AnswerButtonScene2 clickedButton)
    {
