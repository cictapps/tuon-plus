   ...
   private void DisplayCurrentQuestion()
    {
        ...
        if (QuizImage != null && currentQuestion.QuestionImage != null)
        {
            Debug.Log("Assigning sprite: " + currentQuestion.QuestionImage.name);
            QuizImage.texture = currentQuestion.QuestionImage;
        }
        else
        {
            Debug.LogError("Image or QuestionImage is null.");
        }
    ...
    public void AnswerSelected(bool isCorrect, AnswerButton clickedButton)
    {
